...
type Task = {
  ...
  owner: string;
  dueDate: string;
  status: 'Done' | 'Stuck' | 'Working';
  people: string[];
  timeline: string;
};

const tasks: { todo: Task[]; completed: Task[] } = {
  todo: [
    {
      task: 'Write down new tasks when you...',
      owner: 'Amaan Alam',
      dueDate: '11 Oct',
      status: 'Working',
      people: ['/avatars/user2.jpg', '/avatars/user3.jpg'],
      timeline: '12 – 23 Oct',
    },
    {
      task: 'Keep your lists brief.',
      owner: 'Amaan',
      dueDate: '13 Oct',
      status: 'Stuck',
      people: ['/avatars/user1.jpg', '/avatars/user4.jpg'],
      timeline: '-',
    },
    {
...
const TaskTable = ({ title, data }: { title: string; data: Task[] }) => (
    ...
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-gray-200 text-sm">
        <thead className="bg-gray-50">
          <tr>
            {['Task', 'Owner', 'Status', 'Due date'].map((header) => (
              <th
                key={header}
    ...
    <>
      <main className="min-h-screen bg-gray-200 py-10 px-6">
        <div className="max-w-7xl mx-auto">
          <TaskTable title="To Do" data={tasks.todo} />
